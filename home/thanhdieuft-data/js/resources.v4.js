...
<audio style="display: none;" id="__kudasai__"><source src="" type="audio/mpeg"></audio>
<header>
  <div class="Container">
  <div id="td_Title">
...
<div class="ThanhDieuMain">
  <img class="Avatar" src="https://imgur.com/nQRJOon.jpg" width="120" height="120" alt="quang">
  <h2 class="HoVaTen__">
...
<div class="MangXaHoiFtThanhDieu" id="ThanhDieuFtCredits">
  ...
  <a id="Facebook" onclick="Facebook()">
    <div class="Facebook">
      <i class="bi bi-facebook">&nbsp; </i>Facebook (102K+)
    </div>
  </a>
  <br>
  <a id="Youtube" onclick="Youtube()">
    <div class="Youtube">
      <i class="bi bi-youtube">&nbsp; </i>Youtube (50+)
    </div>
  </a>
  <br>
  <a id="Discord" onclick="Discord()">
    <div class="Discord">
      <i class="bi bi-discord">&nbsp; </i>Discord (8+)
    </div>
  </a>
  <br>
  ...
  <div class="col-lg-6 col-12">
    <div class="skill-box">
      <div class="skill">
        ...
        <div class="skill-bar">
          <div class="skill-per color_javascript__" per="60%" style="width: 60%;"></div>
        </div>
      </div>
      <div class="skill">
        <div class="skill-name">PYTHON</div>
        <div class="skill-bar">
          <div class="skill-per color_python__" per="80%" style="width: 80%;"></div>
        </div>
      </div>
    </div>
</div>
<hr class="ThanhGachNgang">
<u class="NameFtThanhDieu">- NULL BYTE -</u>
</section>
<div class="XuongDong__">&nbsp;</div>
<div class="ThongTinThanhToan">
    <p class="ThongTinThanhToanTitle"> NOTHING IS  </p>
    <p class="ThongTinThanhToanText">IMPOSSIBLE</</p>
    </div>
    <div class="XuongDong__">&nbsp;</div>
<hr class="ThanhGachNgang">
<div class="XuongDong__">&nbsp;</div>
...
<div id="Toast">Resources Code V5.0.8</div>
`;
...
const ThanhDieu_List = [
  "//files.catbox.moe/vk1j7z.mp3",
  "https://files.catbox.moe/8fx3ys.mp3",
];
//Random music
...
function HomeThanhDieu() {
  Swal.fire({
    ...
    html: '<span class="rainbow-text">=>> CODER X PYTHON X C++ X DEV <<=</span>',
...
strings: ["my name is MinhQuang","'NOT HACK NOT TRICK' ", "'NO BOTNET NOT KEYLOGER'"],
typeSpeed: 95,
backSpeed: 75,
loop: true
})
...
function ThanhDieuLinkSocial(link) {
  ...
  function Facebook() {
    ThanhDieuLinkSocial('//facebook.com/100014053117503');
  }
